...
2.  **(Рекомендуется)** Создайте и активируйте виртуальное окружение:
    ...
    # Или используя стандартный venv
    python -m venv .venv
...
3.  **Установите утилиту и все зависимости:**
    ```bash
    # Установка в редактируемом режиме с uv
    uv sync
...
Для разработки нужно установить дополнительные зависимости (pytest, coverage и т.д.):
...
pytest tests/ --cov=polyglot_rpg

# Запустить конкретный тест
pytest tests/test_cache_glossary.py
```

### Структура тестов

Тесты находятся в директории `tests/`:
- `test_cache_glossary.py` - тесты кеша с учетом глоссария
